...
import com.junka.core.testing.LocationObserverFake
import com.junka.core.testing.MainCoroutineExtension
import com.junka.core.testing.PhoneToWatchConnectorFake
...
class RunningTrackerTest {
    ...
    fun testCombiningRunData() = runTest {
        runningTracker.runData.test {
            ...
            watchConnectorFake.sendFromWatchToPhone(MessagingAction.HearRateUpdate(160))
            val emission3 = awaitItem()

            watchConnectorFake.sendFromWatchToPhone(MessagingAction.HearRateUpdate(170))
