...
import com.junka.core.connectivity.domain.DeviceType.PHONE
import com.junka.core.connectivity.domain.DeviceType.WATCH
    ...
    override fun observeConnectedDevices(localDeviceType: DeviceType): Flow<Set<DeviceNode>> {
        return callbackFlow {
            val remoteCapability = when (localDeviceType) {
                WATCH -> "runique_phone_app"
                PHONE -> "runique_wear_app"
            }
