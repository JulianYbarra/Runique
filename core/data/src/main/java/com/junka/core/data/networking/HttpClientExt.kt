package com.junka.core.data.networking

import com.junka.core.data.BuildConfig
...
suspend inline fun <reified RequestType, reified Response : Any> HttpClient.post(
    route: String,
    body : RequestType
): Result<Response, DataError.Network> {
    return safeCall {
